...
Проект представляет собой полноценный аналитический сервис для автоматизированной работы со статистическими данными Мосстата по г. Москве.
...
Это отдельная часть проекта, реализованная в системе **Cubisio**. В ней реализовано:
